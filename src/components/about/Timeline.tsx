      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          <div className="flex flex-col items-center bg-white p-8 rounded-xl shadow-lg">
            <div className="relative w-72 h-78 rounded-full overflow-hidden mb-10 border-4 border-red-600">
              <img
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">{schoolHistory.founder.name}</h3>
            <p className="text-xl font-semibold text-red-600 mb-4">{schoolHistory.founder.title}</p>
            <p className="text-gray-600 text-center text-lg leading-relaxed max-w-md">{schoolHistory.founder.bio}</p>
          </div>
        </div>
      </div>
    </div>
